...
public class ComponentCaptureViewController: CommonCaptureViewController {
    ...
    public override func returnToParent(){
    ...
    func processSuccessId(){
        ...
        self.idCaptureResponse.result.result = lastValidateFace!.result!
        self.idCaptureResponse.result.confidence = lastValidateFace!.confidence!
        self.idCaptureResponse.result.retro = outputRetro
        self.idCaptureResponse.reasonFail = .none
        self.idCaptureResponse.error = .none
        
        //self.idCaptureResponse.front = (self.bestDocument?["front"]!.documentImage())!
        //self.idCaptureResponse.back = (self.bestDocument?["back"]!.documentImage())!
